...
public class ContextConfig {
    ...
    private String bizEnLowName;//业务英文名称(小写)
    private String moduleName = "system";  //模块名称
    private String moduleLowName = "system";  //模块名称(小写)
    ...
    public void setBizEnName(String bizEnName) {
        ...
        this.bizEnLowName = bizEnName.toLowerCase();
    }
    ...
    public void setModuleName(String moduleName) {
        ...
        this.moduleLowName = moduleName.toLowerCase();
    }
    ...
    public String getModuleLowName() {
        return moduleLowName;
    }

    public void setModuleLowName(String moduleLowName) {
        this.moduleLowName = moduleLowName;
    }

    public String getBizEnLowName() {
        return bizEnLowName;
    }

    public void setBizEnLowName(String bizEnLowName) {
        this.bizEnLowName = bizEnLowName;
    }
}
