...
public class DaoConfig {
    ...
    public void init() {
        ...
        this.daoPathTemplate = "\\src\\main\\java\\cn\\ibdsr\\web\\modular\\" + moduleLowName + "\\dao\\{}Dao.java";
        this.xmlPathTemplate = "\\src\\main\\java\\cn\\ibdsr\\web\\modular\\" + moduleLowName + "\\dao\\mapping\\{}Dao.xml";
        this.packageName = "cn.ibdsr.web.modular." + moduleLowName + ".dao";
    }
