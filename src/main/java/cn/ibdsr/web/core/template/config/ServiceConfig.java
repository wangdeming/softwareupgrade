package cn.ibdsr.web.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        String moduleLowName = contextConfig.getModuleLowName();
        ArrayList<String> imports = new ArrayList<>();
        imports.add("org.springframework.stereotype.Service");
        imports.add("cn.ibdsr.web.modular." + moduleLowName + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        this.serviceImplImports = imports;
        this.servicePathTemplate = "\\src\\main\\java\\cn\\ibdsr\\web\\modular\\" + moduleLowName + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\cn\\ibdsr\\web\\modular\\" + moduleLowName + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = "cn.ibdsr.web.modular." + moduleLowName + ".service";
    }
