...
Software.initColumn = function () {
    return [
        ...
        {title: '排序',field:"sequence",visible: true, align: 'center',valign: 'middle',width:100,
        ...
        {title: '最新安装包名称', field: 'app_name', visible: true, align: 'center', valign: 'middle'},
        {title: '包名', field: 'package_name', visible: true, align: 'center', valign: 'middle'},
        {title: '最新版本号', field: 'version_no', visible: true, align: 'center', valign: 'middle'},
        {title: '最新安装包大小', field: 'size', visible: true, align: 'center', valign: 'middle'},
        ...
        {title: '是否强制更新', field: 'is_force', visible: true, align: 'center', valign: 'middle'},
        {title: '更新时间', field: 'createdTime', visible: true, align: 'center', valign: 'middle'},
        {title: '操作', field: 'package_name', visible: true, align: 'center', valign: 'middle',width:250,
            formatter:function(value,row,index){
                ...
                if(package_name == null){
                    var x = '<a style="margin-right: 30px;" onclick="Software.uploadPackage(\''+ row.id + '\')">上传安装包</a>';
                    var y = '<a style="margin-right: 30px;" onclick="Software.openSoftwareDetail(\''+ row.id + '\',\''+ row.code + '\',\''+ row.name + '\',\''+ row.type + '\',\''+ row.intro + '\',0)">编辑</a>';
                    var e = '<a onclick="Software.delete(\''+ row.id + '\')">删除</a> ';
                    z=x+y+e;
                }else {
                    var x = '<a style="margin-right: 30px;" onclick="Software.uploadPackage(\''+ row.id + '\')">上传安装包</a>';
                    var y = '<a style="margin-right: 30px;" onclick="Software.openSoftwareDetail(\''+ row.id + '\',\''+ row.code + '\',\''+ row.name + '\',\''+ row.type + '\',\''+ row.intro + '\',1)">编辑</a>';
                    var e = '<a onclick="Software.goToVersionrecord(\''+ row.id + '\',\''+ row.name + '\')">版本记录</a>';
                    z=x+y+e;
                }
                return z;
            }
...
Software.goToVersionrecord = function (id,name) {
