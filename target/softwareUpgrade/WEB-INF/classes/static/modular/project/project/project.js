...
Project.initColumn = function () {
    return [
        ...
        {title: '项目代号', field: 'code', visible: true, align: 'center', valign: 'middle'},
        ...
        {title: '包含软件数量', field: 'software_num', visible: true, align: 'center', valign: 'middle',
            formatter:function(value,row,index){
        ...
        {title: '操作', field: 'software_num', visible: true, align: 'center', valign: 'middle',
            formatter:function(value,row,index){
                var software_num=row.software_num;
                var z;
...
Project.openProjectDetail = function (id,code,name,intro) {
    ...
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: Feng.ctxPath + '/project/project_update/' + id
    });
    this.layerIndex = index;
};
